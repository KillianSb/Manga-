		...
		<div class="container">
			...
			<div class="collapse navbar-collapse">
				<ul class="nav navbar-nav navbar-right">
                    ...
                    @auth
                    	<li>
                   			<a href="{{ route('livresuser.index') }}">LISTE DES OUVRAGES</a>
                   		</li>
                    	<li>
                    		<a href="{{ url('/logout') }}"
                    	...
                    	<li>
                    		<a href="{{ route('admin') }}" class="header_admin">Admin Panel</a>
                    	</li>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <p>Manga++ est spécialisé dans la location de mangas et de bandes dessinées.
                       Réservez en ligne et venez récupérer votre ouvrage en magasin.</p>
                    <p>Disponibilité des nouveautés le jour de leur sorties</p>

                </div>
                <div class="first_welcome_image">
                    <img src="images/asterix_JO_n1.jpg" class="img-responsive img-bordered img-about" alt="about img" width="250px" height="250px">
                </div>
                <div class="second_welcome_image">
                    <img src="images/naruto_n1.jpg" class="img-responsive img-bordered img-about" alt="about img" width="250px" height="250px">
                </div>
            </div>
        </div>
    </section>
